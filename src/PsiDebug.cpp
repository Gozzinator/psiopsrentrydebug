...
bool PsiDebug::m_bGodModeCheat;
bool PsiDebug::m_bNoclipCheat;
bool PsiDebug::m_bInfinitePsiCheat;
...
int PsiDebug::ActivateCustomCheatCode(CustomCheatCode cheatCode)
{
    switch (cheatCode)
    {
        ...
        case GOD_MODE:
        {
            // Toggle so it can be switched back off from the same code
            m_bGodModeCheat = !m_bGodModeCheat;
            break;
        }
        case NOCLIP:
        {
            m_bNoclipCheat = !m_bNoclipCheat;
            break;
        }
        case INFINITE_PSI:
        {
            m_bInfinitePsiCheat = !m_bInfinitePsiCheat;
            break;
        }
